...
python3 user_master_noise.py $usersize $noise && python3 city_master_noise.py $citysize $noise && python3 city_hotel_mapping_noise.py $citysize $noise && python3 bounced_data_noise.py $bouncedatasize $noise && python3 transaction_data_noise.py $noise
